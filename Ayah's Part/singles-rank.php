...
<html lang="en">
  <head>
    ...
    <title>Men's Singles Rankings</title>
  </head>
  <body>
    <!--menu-->
    <div class="topnav">
    ...
    <div class="dropdown" id="center">
      ...
      <div id="myDropdown" class="dropdown-content">
        ...
        <a href="#" id="m20" onclick="one();">2020 Men's Singles</a>
        <a href="#" id="m19" onclick="two();">2019 Men's Singles</a>
        <a href="#" id="m18" onclick="three();">2018 Men's Singles</a>
        <a href="#" id="m17" onclick="four();">2017 Men's Singles</a>
        <a href="#" id="m16" onclick="five();">2016 Men's Singles</a>
      </div>
    </div>
    ...
    <?php
      if ($dbOk) {
        $query = 'select * from mensingles2020 order by rank';
    ...
    <?php
      if ($dbOk) {
        $query = 'select * from mensingles2019 order by rank';
        $result = $db->query($query);
        $numRecords = $result->num_rows;        
        echo '<tr><th>Rank:</th><th>Name:</th><th>Country:</th><th>Points:</th><th></th></tr>';
        for ($i=0; $i < $numRecords; $i++) {
    ...
    <?php
      if ($dbOk) {
        $query = 'select * from mensingles2018 order by rank';
        $result = $db->query($query);
        $numRecords = $result->num_rows;        
        echo '<tr><th>Rank:</th><th>Name:</th><th>Country:</th><th>Points:</th><th></th></tr>';
        for ($i=0; $i < $numRecords; $i++) {
    ...
    <?php
      if ($dbOk) {
        $query = 'select * from mensingles2017 order by rank';
        $result = $db->query($query);
        $numRecords = $result->num_rows;        
        echo '<tr><th>Rank:</th><th>Name:</th><th>Country:</th><th>Points:</th><th></th></tr>';
        for ($i=0; $i < $numRecords; $i++) {
    ...
    <?php
      if ($dbOk) {
        $query = 'select * from mensingles2016 order by rank';
        $result = $db->query($query);
        $numRecords = $result->num_rows;        
        echo '<tr><th>Rank:</th><th>Name:</th><th>Country:</th><th>Points:</th><th></th></tr>';
        for ($i=0; $i < $numRecords; $i++) {
